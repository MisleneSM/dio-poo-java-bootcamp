...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteudos inscritos Mislene " + devMislene.getConteudosInscritos());
        devMislene.progredir();
        System.out.println("-------");
        System.out.println("Conteudos inscritos Mislene " + devMislene.getConteudosInscritos());
        System.out.println("Conteudos concluidos Mislene " + devMislene.getConteudosConcluidos());
